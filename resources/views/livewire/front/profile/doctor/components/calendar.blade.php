<div>
    <div class="mt-24 mx-5 my-12">
        <h2 class="text-sm font-medium mb-12 text-gray-500">Próximos turnos</h2>
        ...
        <section class="mt-12 md:mt-0 md:pl-14">
            <h2 class="text-base font-semibold leading-6 text-gray-900">Eventos para: <time datetime="2022-01-21">21 de Enero, 2024</time></h2>
            <ol class="mt-4 space-y-1 text-sm leading-6 text-gray-500">
                <li class="group flex items-center space-x-4 rounded-xl px-4 py-2 focus-within:bg-gray-100 hover:bg-gray-100">
                    ...
                    <div class="flex-auto">
                        <p class="text-black">Leslie Alexander</p>
                        <p class="text-gray-500">Turno confirmado: "Consulta por tratamiento escoliosis"</p>
