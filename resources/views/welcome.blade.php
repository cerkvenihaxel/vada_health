...
<div class="bg-white">
        ...
        <nav class="mx-auto flex max-w-7xl items-center justify-between p-6 lg:px-8" aria-label="Global">
            <div class="flex lg:flex-1">
                <a href="#" class="-m-1.5 p-1.5">
                    ...
                    <img class="h-8 w-auto" src="/logo-vada.png" alt="">
                </a>
            </div>
            ...
            <div class="hidden lg:flex lg:flex-1 lg:justify-end">
                <a href="{{route('login')}}" class="text-sm font-semibold leading-6 text-gray-900">Iniciar sesión <span aria-hidden="true">&rarr;</span></a>
            </div>
        </nav>
        ...
        <div class="lg:hidden" role="dialog" aria-modal="true">
            ...
            <div class="fixed inset-y-0 right-0 z-50 w-full overflow-y-auto bg-white px-6 py-6 sm:max-w-sm sm:ring-1 sm:ring-gray-900/10">
                <div class="flex items-center justify-between">
                    <a href="#" class="-m-1.5 p-1.5">
                        <span class="sr-only">VADA Health</span>
    ...
    <main class="isolate">
        <!-- Hero section -->
        <div class="relative isolate -z-10 overflow-hidden bg-gradient-to-b from-orange-100/20 pt-14">
            ...
            <div class="mx-auto max-w-7xl px-6 py-32 sm:py-40 lg:px-8">
                <div class="mx-auto max-w-2xl lg:mx-0 lg:grid lg:max-w-none lg:grid-cols-2 lg:gap-x-16 lg:gap-y-6 xl:grid-cols-1 xl:grid-rows-1 xl:gap-x-8">
                    <h1 class="max-w-2xl text-4xl font-bold tracking-tight text-gray-900 sm:text-6xl lg:col-span-2 xl:col-auto"><a class="text-orange-500">VADA Health.</a> Servicios de medicina digital.</h1>
                    <div class="mt-6 max-w-xl lg:mt-0 xl:col-end-1 xl:row-start-1">
                        <p class="text-lg leading-8 text-gray-600">Transformando la Atención Médica con Tecnología Innovadora. Mejora la eficiencia, coordina equipos y brinda una atención excepcional a los pacientes en clínicas, hospitales y más. Únete a la revolución de la salud hoy mismo.</p>
                    </div>
        ...
        <div class="mx-auto mt-32 max-w-7xl sm:mt-40 sm:px-6 lg:px-8">
            <div class="relative isolate overflow-hidden bg-gray-900 px-6 py-24 text-center shadow-2xl sm:rounded-3xl sm:px-16">
                <h2 class="mx-auto max-w-2xl text-3xl font-bold tracking-tight text-white sm:text-4xl">Confían en nosotros.</h2>
                <p class="mx-auto mt-4 max-w-xl text-lg leading-8 text-gray-300">
                    Somos una empresa comprometida y responsable que se enorgullece de construir relaciones sólidas con nuestros clientes. Nuestro enfoque en la excelencia y la integridad nos ha permitido ganarnos la confianza de numerosas organizaciones que valoran nuestros servicios confiables y de alta calidad. Estamos dedicados a brindar soluciones que marcan la diferencia y fortalecen el éxito de quienes eligen trabajar con nosotros.
                </p>
            ...
            <div class="mx-auto max-w-7xl px-6 lg:flex lg:px-8">
                <div class="mx-auto grid max-w-2xl grid-cols-1 gap-x-12 gap-y-16 lg:mx-0 lg:min-w-full lg:max-w-none lg:flex-none lg:gap-y-8">
                    <div class="lg:col-end-1 lg:w-full lg:max-w-lg lg:pb-8">
                        <h2 class="text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">Nuestra cultura.</h2>
                        <p class="mt-6 text-xl leading-8 text-gray-600">En nuestra empresa joven, la innovación y la pasión son los cimientos de nuestra cultura. Nos enorgullece fomentar un ambiente dinámico y creativo donde cada idea cuenta y cada miembro del equipo tiene la oportunidad de crecer. Valoramos la diversidad de pensamiento y abrazamos el cambio, impulsados por el deseo de superar los límites y alcanzar nuevos horizontes. Juntos, estamos construyendo un camino emocionante hacia el futuro.
                        </p>
                    </div>
        ...
        <div class="mx-auto mt-32 max-w-7xl px-6 sm:mt-40 lg:px-8">
            <div class="mx-auto flex max-w-2xl flex-col items-end justify-between gap-16 lg:mx-0 lg:max-w-none lg:flex-row">
                <div class="w-full lg:max-w-lg lg:flex-auto">
                    <h2 class="text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">Súmate a nosotros!</h2>
                    <p class="mt-6 text-xl leading-8 text-gray-600">Puestos disponibles para personas con ganas de aprender y crecer.</p>
                ...
                <div class="w-full lg:max-w-xl lg:flex-auto">
                    ...
                    <div class="mt-8 flex border-t border-gray-100 pt-8">
                        <a href="#" class="text-sm font-semibold leading-6 text-orange-600 hover:text-orange-500">View all openings <span aria-hidden="true">&rarr;</span></a>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="border-t border-gray-900/10 pt-20 xl:grid xl:grid-cols-3 xl:gap-8">
                ...
                <div class="mt-10 xl:mt-0">
                    ...
                    <form class="mt-6 sm:flex sm:max-w-md">
                        ...
                        <input type="email" name="email-address" id="email-address" autocomplete="email" required class="w-full min-w-0 appearance-none rounded-md border-0 bg-white px-3 py-1.5 text-base text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-orange-600 sm:w-64 sm:text-sm sm:leading-6 xl:w-full" placeholder="Enter your email">
                        <div class="mt-4 sm:ml-4 sm:mt-0 sm:flex-shrink-0">
                            <button type="submit" class="flex w-full items-center justify-center rounded-md bg-orange-600 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-orange-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-orange-600">Subscribe</button>
                        </div>
                    </form>
                </div>
            </div>
